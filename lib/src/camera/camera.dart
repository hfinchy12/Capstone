...
/// Contains the full implementation for the camera screen.
class CameraPage extends StatefulWidget {
  final String category; // Add category parameter

  /// Constructs the CameraPage storing category information passed from the [CategoryPage]
...
class _CameraPageState extends State<CameraPage> {
  ...
  /// The functionality for the pop-up button feature. Displays tips depending on the category from [CategoryPage]
  ...
  /// Flips the camera between front and back facing whenever the flip-camera button is pressed.
  ...
  /// Toggles the visibility of the leveling bar
  ...
  /// Sets the focus point for tap-to-focus
  ...
  /// Handles the exact position on the screen to direct the focus.
  ///
  ...
  /// Provides visual feedback to the user when tapping somewhere on the screen
  ...
  /// Displays the current zoom level to a user after pinching in or outwards.
...
/// Creates the grid overlay that appears over the camera screen when the grid button is pressed
